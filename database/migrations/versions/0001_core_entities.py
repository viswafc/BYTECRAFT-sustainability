...
Revision ID: 0001_core_entities
Revises: 
Create Date: 2026-09-18 08:32:12.719283
"""
from alembic import op
import sqlalchemy as sa


revision = '0001_core_entities'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_lines_status'), 'lines', ['status'], unique=False)
    op.create_index(op.f('ix_lines_zone_id'), 'lines', ['zone_id'], unique=False)
    ...
    op.create_index(op.f('ix_machines_line_id'), 'machines', ['line_id'], unique=False)
    ...
    op.create_index('ix_incidents_plant_status', 'incidents', ['plant_id', 'status'], unique=False)
    ...
    op.create_index('ix_sensor_readings_sensor_ts', 'sensor_readings', ['sensor_id', 'timestamp'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_incidents_plant_status', table_name='incidents')
    ...
    op.drop_index(op.f('ix_machines_line_id'), table_name='machines')
    op.drop_table('machines')
    op.drop_index(op.f('ix_lines_zone_id'), table_name='lines')
    op.drop_index(op.f('ix_lines_status'), table_name='lines')
    op.drop_table('lines')
